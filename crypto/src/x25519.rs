...
//! use crypto::traits::ValidKeyStringExt;
//! # fn main() -> Result<(), crypto::traits::CryptoMaterialError> {
...
use crypto_derive::{DeserializeKey, SerializeKey, SilentDebug, SilentDisplay};
...
#[derive(Clone, SilentDebug, SilentDisplay, SerializeKey, DeserializeKey)]
...
impl FromStr for PrivateKey {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        <Self as ValidKeyStringExt>::from_encoded_string(s)
    }
}
